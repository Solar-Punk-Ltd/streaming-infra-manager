...
| `chain_endpoint_missing` | Nothing is configured for the node's chain and the node was started without a usable endpoint. | Give the deployment a chain endpoint and deploy it again, or set `CHEQUEBOOK_RPC_ENDPOINTS`. |
