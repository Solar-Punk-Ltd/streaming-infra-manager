...
which reads the key at all, and the bundled stack, `v3.2`, falls
...
stack, `v3.2` as of 2026-09-24, publishes SRS's HTTP API port per
...
(99 on the bundled `v3.2`, 999 on the older `main-v2`, and the
