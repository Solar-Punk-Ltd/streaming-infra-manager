...
export const runningProfile: Profile = {
  ...
  instance_id: '11111111-1111-4111-8111-111111111111', engine_config_revision: 0, intent_revision: 0, last_full_deploy_commit: null,
  containers: [{ service: 'srs', ports: {}, buildId: null, buildCommit: null }, { service: 'bee-uploader', ports: {}, buildId: null, buildCommit: null }],
};
