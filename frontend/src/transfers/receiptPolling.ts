 ...
 *
 * Capped at one whole budget after the record last changed, because the manager
 * writes the deadline and `updated_at` in the same statement and `updated_at`
 * only moves forward. So the cap never cuts an honest deadline short, and a
