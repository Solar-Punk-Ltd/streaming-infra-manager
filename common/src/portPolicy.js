...
export const PUBLIC_PORT_ROLES = Object.freeze([
  ...
  { group: 'srt_ingest', protocol: 'udp', base: 10001, maxSlot: MANAGER_SLOT_CAP, portVar: 'SRS_SRT_PORT', service: 'srs' },
...
export function portExposureProblem(entry) {
  ...
  if (role && (entry.portVar !== role.portVar || entry.service !== role.service)) {
