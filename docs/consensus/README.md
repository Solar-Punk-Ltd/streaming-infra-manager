...
| `T27-NODE-MODE-BRIEF.md` | Row T27, ruled 2026-09-17: a Bee node's mode, light or ultra-light, and its RPC endpoint are chosen when the node is created. The four implementation choices and their reasons, the three halves and their order. Open work, the fixes file follows the reviews. |
