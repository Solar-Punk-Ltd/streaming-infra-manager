...
| R06 | 8cad6df includes immutable master/rung selection, replay-to-newer-replay switching and replay retention during preparation. Real Chrome focused browser checks passed 3 cases. Full-suite fixture and unused-export repairs retain the existing gates | Full positive/negative verification and real decode remain pending |
